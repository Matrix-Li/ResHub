...
export default {
  ...
  methods: {
    ...
    Reg() {
      ...
      axios
        .post(baseUrl + "/registerInformation", data)
        .then(function(response) {
    ...
    askVerificationCode() {
      ...
      axios
        ...
        .then(function(response) {
          ...
          console.log(
            "askVerificationCode:response.data.result:" + response.data.result
          );
        })
